#!/usr/bin/python3
"""
View for handling Review objects related to Place objects via RESTful API actions.
"""
...
def reviews_all(place_id):
    """Returns a list of all Review objects for a specific Place"""
...
def review_post(place_id):
    """Handles POST method to create a new Review for a specific Place"""
    place = storage.get("Place", place_id)
    if place is None:
        abort(404)
