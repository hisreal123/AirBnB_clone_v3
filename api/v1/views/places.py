...
def places_per_city(city_id=None):
    """
    places route to handle HTTP methods for requested places by city
    """
    ...
    if request.method == 'GET':
        ...
        city_places = [obj.to_json() for obj in all_places.values() if obj.city_id == city_id]
    ...
    if request.method == 'POST':
        ...
        Place = CNC.get("Place")
        if Place is None:
            abort(500, 'Server error: Place model not found')
